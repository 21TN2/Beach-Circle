...
import 'package:beach_circle_flutter/moderation/report_submitted.dart';
import 'package:flutter/material.dart';
import 'package:beach_circle_flutter/moderation/moderation_service.dart';
import 'package:image_picker/image_picker.dart';
import 'package:beach_circle_flutter/moderation/cloudinary_service.dart';

class ReportIssuePage extends StatefulWidget {
  const ReportIssuePage({
    super.key,

    // Existing fields: keep these so Student Misc + Dorm Life still work
    this.postId,
    this.postAuthorId,

    // New fields: use these for Outlet, Study Hall, Bathroom, Food Alert, etc.
    this.targetId,
    this.reportedUserId,
    this.targetType,
  }) : assert(
         (postId != null && postAuthorId != null) ||
             (targetId != null && reportedUserId != null && targetType != null),
         'Provide either postId/postAuthorId OR targetId/reportedUserId/targetType.',
       );
...
class _ReportIssuePageState extends State<ReportIssuePage> {
  ...
  // NEW FROM GISELLE: Cloudinary image upload for report screenshots
  ...
  // NEW FROM GISELLE: pick image from gallery and upload to Cloudinary
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      // NEW: map features and other non-post content use targetId/targetType
      if (widget.targetId != null &&
        ...
        // Existing behavior: Student Misc + Dorm Life can still use postId/postAuthorId
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      child: Text(
                        _uploadingImage ? 'Uploading...' : '+ Add a Photo',
