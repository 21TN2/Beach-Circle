// eb_create.dart
// Add Event Details form — wired to EbServices & EventBoardEvent model
...
class _EbCreatePageState extends State<EbCreatePage> {
  ...
  EventBoardCategory   _selectedCategory = EventBoardCategory.athletics;
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      final building = buildings.firstWhere(
        ...
        orElse: () => {
          'code': _selectedBuildingCode!,
          'name': _selectedBuildingCode!
        },
      );
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: kBg,
                border:
                    Border.all(color: const Color(0xFFD8D8D8), width: 1.5),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: _pickerCol(
                    ...
                    onChanged: (i) =>
                        setState(() => _selectedHour = hours[i]),
                  ),
                ),
                Expanded(
                  flex: 2,
    ...
    return CupertinoPicker(
      ...
      selectionOverlay: Container(
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: const Color(0xFFD4A800), width: 1.5),
        ),
      ),
      children: items
          .map((item) => Center(
              ...
              fieldViewBuilder:
                ...
                return Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                        color: const Color(0xFFD8D8D8), width: 1.5),
                  ),
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText:
                          'Search building or abbreviation...',
                      hintStyle:
        ...
        Expanded(
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: const BorderSide(
                  color: Color(0xFFD8D8D8), width: 2),
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(12)),
            ),
            child: const Text(
