...
import 'dorm_category_dot.dart';

/// Horizontally scrollable date strip.
/// Pass [selectedDate] and [onDateSelected] from the parent screen's setState.
class DormDateStrip extends StatefulWidget {
  ...
  @override
  State<DormDateStrip> createState() => _DormDateStripState();
}

class _DormDateStripState extends State<DormDateStrip> {
  late ScrollController _scroll;
  late List<DateTime> _days;

  final Map<String, List<DormCategory>> _dotCache = {};
